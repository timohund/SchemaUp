 ...
 */
class Domain_Database_Table_Collection extends System_AbstractCollection implements Interface_SqlCreater{
	 ...
	 * @return boolean
	 */
	public function hasTable(Domain_Database_Table $tableToSearch) {
	 ...
	 * 
	 * @param Domain_Database_Table $tableToSearch
	 * @return Domain_Database_Table returns the table or false if the table is not in the collection
	 */
	public function getTable(Domain_Database_Table $tableToSearch) {
		$result = false;
